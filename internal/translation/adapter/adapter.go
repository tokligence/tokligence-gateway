...
type AnthropicMessageRequest struct {
	...
	ComputerUse    json.RawMessage `json:"computer_use,omitempty"`
	MCPServers     json.RawMessage `json:"mcp,omitempty"`
	PromptCaching  json.RawMessage `json:"prompt_caching,omitempty"`
...
func AnthropicToOpenAI(areq AnthropicMessageRequest) (OpenAIChatRequest, error) {
	...
	if sm := systemToOpenAI(areq.System); sm != nil {
		out = append(out, *sm)
	}
