...
const (
    PriorityCritical   PriorityTier = 1  // Internal services
    PriorityHigh       PriorityTier = 2  // Paid users
    PriorityMedium     PriorityTier = 3  // Free tier (default)
    PriorityLow        PriorityTier = 4  // External/anonymous
    PriorityBackground PriorityTier = 5  // Batch jobs
)

type PriorityQueue struct {
    queues [5]*Queue  // One queue per priority tier
    mu     sync.RWMutex
}
